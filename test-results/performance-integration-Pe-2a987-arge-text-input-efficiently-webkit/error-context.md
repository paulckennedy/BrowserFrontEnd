...
- generic [ref=e1]:
  - banner [ref=e2]:
    ...
    - generic [ref=e3]:
      ...
      - generic [ref=e14]:
        - generic [ref=e15]: Unsaved changes
  ...
  - main [ref=e17]:
        ...
        - generic [ref=e31]:
          ...
          - generic [active] [ref=e57]:
            ...
            - list [ref=e72]:
              ...
              - listitem [ref=e74]: Your changes are automatically savedThis is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content. This is a performance test with repeated content.
          ...
          - generic [ref=e87]:
            - generic [ref=e88]: 196 words
            - generic [ref=e89]: 1974 characters
            - generic [ref=e90]: Cursor position updated
    ...
    - generic [ref=e92]:
      ...
      - generic [ref=e96]:
        ...
        - generic [ref=e98]: ⏸️ Auto-save paused (editing...)
